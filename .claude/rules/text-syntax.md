...
- **Exceptions**: tree-drawing characters in diagrams (e.g. box-drawing lines in ASCII-art directory trees) and natural-language content such as author names or internationalized user-facing strings.
